...
export class CreateImageDto {
  @ApiProperty({ description: 'ID of the bike (required if serviceId not provided)', required: false })
  @ValidateIf(o => !o.serviceId)
  @IsInt()
  @Type(() => Number)
  bikeId?: number;

  @ApiProperty({ description: 'ID of the service (required if bikeId not provided)', required: false })
